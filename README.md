...
La integración de estas fuentes permite enriquecer significativamente el análisis, ya que no solo se identifican las especies incautadas, sino también su nivel de riesgo a nivel global. Para lograr esto, el pipeline realiza procesos de extracción, limpieza, transformación, validación y carga en un Data Warehouse en MySQL, bajo un modelo dimensional que facilita el análisis. Ademas de su respectiva orquestación en airflow, como agregación final se implementa una canalización de datos reproducible, automatizada y validada que combina el procesamiento por lotes, la validación de la calidad de los datos, el modelado dimensional, la generación de informes analíticos y un componente de transmisión mediante Kafka.
